...
valorAposta = 1000, -- preço, em GPS, de cada chance
pos = {{x = 1598,y = 365,z = 4,stackpos = 253},{x = 1599,y = 365,z = 4,stackpos = 253},{x = 1600,y = 365,z = 4,stackpos = 253}}, -- configure as 3 posições
criaturas = {"Rabbit","deer","pig"}, -- monstros que irão aparecer
...
doSendAnimatedText(getCreaturePosition(cid), "Parabéns você ganhou!", math.random(1,255))
